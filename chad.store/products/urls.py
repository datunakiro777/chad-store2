...
urlpatterns = [
    ...
    path('products/<int:product_id>/images/', ProductImageViewSet.as_view(), name="product_images"),
    path('products/<int:product_id>/images/<int:pk>', ProductImageViewSet.as_view(), name="product_image"),
